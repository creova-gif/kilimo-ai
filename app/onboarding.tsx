...
const ROLE_META: Record<CanonicalRole, { icon: React.ReactNode; color: string }> = {
  smallholder: { icon: <Leaf size={22} color="#3C4A2A" />, color: '#3C4A2A' },
  farmer: { icon: <Sprout size={22} color="#3C4A2A" />, color: '#3C4A2A' },
...
const FEATURES = [
  {
    icon: <Sparkles size={20} color="#3C4A2A" />,
    bg: 'rgba(60, 74, 42, 0.12)',
    label: 'Sankofa AI',
    sub: 'Ushauri wa AI',
  },
  {
    icon: <Leaf size={20} color="#3C4A2A" />,
    bg: 'rgba(60, 74, 42, 0.12)',
    label: 'Crop Scan',
    sub: 'Tambua magonjwa',
  },
...
function createStyles(colors: ReturnType<typeof useTheme>['colors'], isDark: boolean) {
  return StyleSheet.create({
    ...
    progressActive: { backgroundColor: '#3C4A2A', width: 32 },
    progressDone: { backgroundColor: 'rgba(60, 74, 42, 0.5)' },
    stepNum: {
      color: colors.textMute,
      fontSize: 12,
      fontFamily: 'Inter_700Bold',
    ...
    pillActive: { borderColor: '#3C4A2A', backgroundColor: 'rgba(60, 74, 42, 0.15)' },
    pillText: { color: colors.textMute, fontSize: 13, fontFamily: 'Inter_600SemiBold' },
    pillTextActive: { color: '#3C4A2A' },
    ...
    taglineDot: { width: 4, height: 4, borderRadius: 2, backgroundColor: '#3C4A2A' },
    langTagline: {
      color: colors.textMute,
      fontSize: 13,
      fontFamily: 'Inter_600SemiBold',
    ...
    langDivider: {
      width: 40,
      height: 1.5,
      backgroundColor: 'rgba(60, 74, 42, 0.3)',
      marginVertical: 28,
    },
    langPick: {
      color: colors.textMute,
